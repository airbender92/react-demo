...
export const Basic = () => (
  <>
    <h1>Values</h1>
    <dl>
      <StoreRender name="foo.bar" />
      <StoreRender name="foo.baz" />
    </dl>
    <h1>Setter</h1>
    <dl>
...
export const UIStore = () => {
  ...
  return (
    <>
      ...
      />
      <h1 style={{ fontSize }}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt autem eum sit eveniet architecto! Quas consequuntur eveniet assumenda ducimus, ut magnam quasi quos dolorum corrupti id ex officiis perferendis similique!
      </h1>
    </>
  )
}